...
void Loadimage(imageData *img) //This function opens an image and gives an
//sdl surface in the image data struct
{

	//SDL_Init(SDL_INIT_VIDEO);
	printf("%s","Bonjour mettez le nom du fichier que vous voulez ouvrir : ");
	//We ask the user for the path
	scanf("%s",img -> path);
...
//THIS FUNCTION WILL BE USED IN THE FINAL VERSION OF THE PROJET
/*
